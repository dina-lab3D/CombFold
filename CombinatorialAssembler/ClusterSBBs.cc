...
void ClusterSBBs::reportAll(std::ostream& s) {
  ...
  std::cerr << " finalClusters_.size() " << finalClusters_.size() << " size_ " << size_ << " contactHash_.size() " << contactHash_.size() << " numOfRmsdCMs_ " << numOfRmsdCMs_ << " numOfRmsdAll_ " << numOfRmsdAll_ << std::endl;
}
...
void ClusterSBBs::merge() {
  ...
  std::cerr << " size_ " << size_ << " contactHash_.size() " << contactHash_.size() << " numOfRmsdCMs_ " << numOfRmsdCMs_ << " numOfRmsdAll_ " << numOfRmsdAll_ << std::endl;
}
