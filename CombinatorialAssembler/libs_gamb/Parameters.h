...
public:
  ...
  static void readParameters(std::istream& paramStream);
  ...
  static void addParameter(const std::string& paramName, const int value);
  ...
  static void addParameter(const std::string& paramName, const double value);
  ...
  static void addParameter(const std::string& paramName, const std::string& value);
  ...
  static void updateParameter(const std::string& paramName,
  ...
  static ParamType paramType(const std::string& paramName);
  ...
  static int       getInt(const std::string& paramName, const int& defaultValue=0);
  ...
  // not exist a 0 is returned.
  static float     getFloat(const std::string& paramName, const float& defaultValue=0.0);
  ...
  static std::string getString(const std::string& paramName, const std::string& defaultValue=std::string());
  ...
  // tokenize a string.
  static std::string nextToken(std::string& str);
